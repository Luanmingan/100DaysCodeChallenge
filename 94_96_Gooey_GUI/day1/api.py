...
def find_movie_by_director(director_name):
    url = ('http://movie_service.talkpython.fm/api/director/{}'
           ).format(director_name)
    return __get_results(url)


def find_movie_by_imdb_code(imdb_code):
    url = 'http://movie_service.talkpython.fm/api/movie/{}'.format(imdb_code)
